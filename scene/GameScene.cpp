...
void GameScene::Initialize() {
	...
	worldTransform_[PartId::Hip].Initialize();
	//子(1番)
	worldTransform_[PartId::LegL].translation_ = {4, -2.5f, 0};
	...
	worldTransform_[PartId::Hip].Initialize();
	//子(1番)
	worldTransform_[PartId::LegR].translation_ = {-4, -2.5f, 0};
...
//{
	...
	//キャラクター移動処理
	{
		...
		debugText_->Printf("Root:(%f,%f,%f)", worldTransform_[0].translation_.x, worldTransform_[0].translation_.y,
